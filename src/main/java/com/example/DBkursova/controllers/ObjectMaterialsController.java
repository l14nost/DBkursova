...
public class ObjectMaterialsController {
    ...
    public String crewAddPage(@PathVariable int id,Model model){
    ...
    public String crewAdd(@PathVariable int id, @RequestParam int material, @RequestParam int quantity,Model model){
    ...
    public String crewEdit(@PathVariable int id, @RequestParam int material, @RequestParam int quantity,Model model){
    ...
    public String deleteObjectMaterial(@PathVariable int id){
